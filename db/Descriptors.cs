...
public class Item
{
    public Item(ushort type, XElement elem)
    {
        ...
        if ((n = elem.Element("Rarity")) != null)
            Rarity = Utils.FromString(n.Value);
        else
            Rarity = 1;
        ...
        if ((n = elem.Element("BagSlots")) != null)
            BagSlots = Utils.FromString(n.Value);
        else
            BagSlots = -1;

        if ((n = elem.Element("Sell")) != null)
            Sell = Utils.FromString(n.Value);
        else
            Sell = 0;
...
public class QuestReward
{
    ...
    public void FromXML(XElement elem)
    {
        ...
        if ((n = elem.Element("Exp")) != null)
            Exp = Utils.FromString(n.Value);
        else
            Exp = 0;
        if ((n = elem.Element("Fame")) != null)
            Fame = Utils.FromString(n.Value);
        else
            Fame = 0;
        foreach (var i in elem.Elements("Item"))
            Items.Add(i.Value);
    }
}
public class QuestObjective
{
    ...
    public QuestObjective(XElement elem)
    {
        XElement n;
        if (elem.Attribute("id") != null)
            Id = Utils.FromString(elem.Attribute("id").Value);
        else
            Id = 0;
        if ((n = elem.Element("Text")) != null)
            Text = n.Value;
        else
            Text = "Undefined";
    }
...
public class Quest
{
    public ushort QuestType { get; private set; }
    public string QuestId { get; private set; }
    public List<string> QuestRequirement { get; private set; }
    public int LevelRequirement { get; private set; }
