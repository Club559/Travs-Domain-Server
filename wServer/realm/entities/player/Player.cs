...
namespace wServer.realm.entities
{
    ...
    public partial class Player : Character, IContainer, IPlayer
    {
        ...
        protected override void ExportStats(IDictionary<StatsType, object> stats)
        {
            ...
            stats[StatsType.ActiveQuests] = GetQuestString(ActiveQuests);
            stats[StatsType.FinishedQuests] = GetQuestString(FinishedQuests);
            stats[StatsType.CompletedQuests] = GetQuestString(CompletedQuests);
        ...
        public void Death(string killer)
        {
            ...
            try
            {
                Manager.Data.AddPendingAction(db =>
                {
                    ...
                    db.Death(client.Manager.GameData, client.Account, client.Character, killer);
                });
        ...
        {
            if (Nexus == "Wine Cellar")
            {
                World world = client.Player.Client.Player.Client.Player.Client.Player.Client.Player.Client.Player.Client.Player.Client.Player.Client.Player.Manager.AddWorld(new WineCellar());
                client.Reconnect(new ReconnectPacket
                {
                    Host = "",
                    Port = 2050,
